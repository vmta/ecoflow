...
class D3MPHeader(_message.Message):
...
class D3MPSendHeaderMsg(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: _containers.RepeatedCompositeFieldContainer[D3MPHeader]
    def __init__(self, msg: _Optional[_Iterable[_Union[D3MPHeader, _Mapping]]] = ...) -> None: ...

class D3MPRuntimePropertyUpload(_message.Message):
...
class D3MPBMSDetailedReport(_message.Message):
...
class D3MPTimeTaskParamDetail(_message.Message):
    __slots__ = ("type", "val")
...
class D3MPTimeTaskItemV2(_message.Message):
    ...
    task_param: int
    task_param_detail: _containers.RepeatedCompositeFieldContainer[D3MPTimeTaskParamDetail]
    def __init__(self, task_index: _Optional[int] = ..., is_cfg: _Optional[bool] = ..., is_enable: _Optional[bool] = ..., conflict_flag: _Optional[int] = ..., time_mode: _Optional[_Union[TIME_TASK_MODE, str]] = ..., time_param: _Optional[int] = ..., time_table: _Optional[int] = ..., task_type: _Optional[_Union[TIME_TASK_TYPE, str]] = ..., task_param: _Optional[int] = ..., task_param_detail: _Optional[_Iterable[_Union[D3MPTimeTaskParamDetail, _Mapping]]] = ...) -> None: ...

class D3MPDisplayPropertyUpload(_message.Message):
    ...
    current_time_task_v2_item: D3MPTimeTaskItemV2
    utc_timezone: int
    utc_timezone_id: str
    utc_set_mode: int
    bms_err_code: int
...
class D3MPCMSStatus1(_message.Message):
...
class D3MPCMSStatus2(_message.Message):
...
class D3MPCMSHeartBeatReport(_message.Message):
    __slots__ = ("msg32_2_1", "msg32_2_2")
    MSG32_2_1_FIELD_NUMBER: _ClassVar[int]
    MSG32_2_2_FIELD_NUMBER: _ClassVar[int]
    msg32_2_1: D3MPCMSStatus1
    msg32_2_2: D3MPCMSStatus2
    def __init__(self, msg32_2_1: _Optional[_Union[D3MPCMSStatus1, _Mapping]] = ..., msg32_2_2: _Optional[_Union[D3MPCMSStatus2, _Mapping]] = ...) -> None: ...

class D3MPRuntimePropertyReport(_message.Message):
...
class D3MPDisplayPropertyReport(_message.Message):
...
class D3MPSetCommand(_message.Message):
...
class D3MPSetReply(_message.Message):
...
class D3MPSetValue(_message.Message):
...
class D3MPSetMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: D3MPHeader
    def __init__(self, header: _Optional[_Union[D3MPHeader, _Mapping]] = ...) -> None: ...

class D3MPHeaderMessage(_message.Message):
    __slots__ = ("header",)
    HEADER_FIELD_NUMBER: _ClassVar[int]
    header: _containers.RepeatedCompositeFieldContainer[D3MPHeader]
    def __init__(self, header: _Optional[_Iterable[_Union[D3MPHeader, _Mapping]]] = ...) -> None: ...

class D3MPSendHeaderMsgLegacy(_message.Message):
    __slots__ = ("msg",)
    MSG_FIELD_NUMBER: _ClassVar[int]
    msg: D3MPHeader
    def __init__(self, msg: _Optional[_Union[D3MPHeader, _Mapping]] = ...) -> None: ...

class D3MPBMSHeartBeatReport(_message.Message):
