...
from custom_components.ecoflow.sensor import (
    AmpSensorEntity,
...
from custom_components.ecoflow.select import (
    DictSelectEntity,
    TimeoutDictSelectEntity,
)

from custom_components.ecoflow.switch import BeeperEntity, EnabledEntity
...
class Delta3MaxPlus(BaseInternalDevice):
    ...
    def sensors(self, client: EcoflowApiClient) -> list[Any]:
        return [
            ...
            OutWattsSensorEntity(client, self, "pow_get_ac_out", "AC Output Power"),
            ...
            InRawWattsSolarSensorEntity(client, self, "pow_get_pv", "Solar Input Power"),
            InVoltSolarSensorEntity(client, self, "pow_get_pv_vol", "Solar Input Voltage"),
            InMilliampSolarSensorEntity(client, self, "pow_get_pv_amp", "Solar Input Current"),
            ...
            OutWattsSensorEntity(client, self, "pow_get_typec3", const.TYPEC_3_OUT_POWER),
    ...
    def _decode_message_by_type(self, pdata: bytes, header_info: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            # Reference: https://github.com/foxthefox/ioBroker.ecoflow-mqtt/blob/main/lib/dict_data/ef_delta3maxplus_data.js
