...
from custom_components.ecoflow.devices import BaseDevice, const
...
from custom_components.ecoflow.select import DictSelectEntity, TimeoutDictSelectEntity
...
class Delta3MaxPlus(BaseDevice):
    def sensors(self, client: EcoflowApiClient) -> list[SensorEntity]:
        return [
            ...
            OutWattsSensorEntity(client, self, "powGet_12v", "12V DC Output Power"),
